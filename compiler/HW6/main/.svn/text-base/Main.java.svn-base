...
public class Main {
    ...
    public static void main(String argv[]) {
        boolean verbose = true;    // Are we in verbose mode?
        boolean optimize = false;    // Do we want to optimize?
...
//        String sourcefile = "/Users/mbani002/code/comp/hw6/Factorial.java";
//        String sourcefile = "/Users/mbani002/code/comp/Test.java";
//        String sourcefile = "/Users/mbani002/code/comp/HW6/Test1.java";
